...
class mod_assignment_mod_form extends moodleform_mod {
	...
	function definition() {
		...
		//ubah textfield dengan button bertuliskan : Choose a problem..
		$mform->addElement('chooseproblem', 'description', get_string('problem'), null, array('maxlength' => 255, 'size' => 48)); 		
		...
		$mform->addGroupRule('description', $referencegrprules);
